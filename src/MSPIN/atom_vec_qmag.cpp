...
AtomVecQMag::AtomVecQMag(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = (char *)
    "q qm molecule num_bond bond_type bond_atom "
  ...
  fields_restart = (char *)
    ...
    "improper_atom3 improper_atom4";
  fields_create = (char *)
    "q qm molecule num_bond num_angle num_dihedral num_improper nspecial";
...
void AtomVecQMag::grow_pointers()
{
...
void AtomVecQMag::pack_restart_pre(int ilocal)
{
...
void AtomVecQMag::pack_restart_post(int ilocal)
{
...
void AtomVecQMag::unpack_restart_init(int ilocal)
{
  nspecial[ilocal][0] = 0;
  nspecial[ilocal][1] = 0;
  nspecial[ilocal][2] = 0;
...
void AtomVecQMag::data_atom_post(int ilocal)
{
  num_bond[ilocal] = 0;
  num_angle[ilocal] = 0;
